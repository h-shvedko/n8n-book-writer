...
const iso_compliance_1 = require("../types/iso-compliance");
class ComplianceService {
    requirements = iso_compliance_1.ISO17024_REQUIREMENTS;
    /**
     * Validate content against ISO 17024 requirements
     */
    validateIsoCompliance(content) {
        const results = [];
     ...
     */
    performCheck(content, checkItem, requirement) {
     ...
     */
    determineOverallStatus(results, criticalIssues) {
